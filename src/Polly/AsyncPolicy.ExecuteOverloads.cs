...
public abstract partial class AsyncPolicy : PolicyBase, IAsyncPolicy
{
    ...
    public Task ExecuteAsync(Func<Task> action) =>
        ExecuteAsync((_, _) => action(), new Context(), DefaultContinueOnCapturedContext, DefaultCancellationToken);
    ...
    public Task ExecuteAsync(Func<Context, Task> action, IDictionary<string, object> contextData) =>
        ExecuteAsync((ctx, _) => action(ctx), new Context(contextData), DefaultContinueOnCapturedContext, DefaultCancellationToken);
    ...
    public Task ExecuteAsync(Func<Context, Task> action, Context context) =>
        ExecuteAsync((ctx, _) => action(ctx), context, DefaultContinueOnCapturedContext, DefaultCancellationToken);
    ...
    public Task ExecuteAsync(Func<CancellationToken, Task> action, CancellationToken cancellationToken) =>
        ExecuteAsync((_, ct) => action(ct), new Context(), DefaultContinueOnCapturedContext, cancellationToken);
    ...
    public Task ExecuteAsync(Func<Context, CancellationToken, Task> action, IDictionary<string, object> contextData, CancellationToken cancellationToken) =>
        ExecuteAsync(action, new Context(contextData), DefaultContinueOnCapturedContext, cancellationToken);
    ...
    public Task ExecuteAsync(Func<Context, CancellationToken, Task> action, Context context, CancellationToken cancellationToken) =>
        ExecuteAsync(action, context, DefaultContinueOnCapturedContext, cancellationToken);
    ...
    public Task ExecuteAsync(Func<CancellationToken, Task> action, bool continueOnCapturedContext, CancellationToken cancellationToken) =>
        ExecuteAsync((_, ct) => action(ct), new Context(), continueOnCapturedContext, cancellationToken);
    ...
    [DebuggerStepThrough]
    public Task ExecuteAsync(Func<Context, CancellationToken, Task> action, IDictionary<string, object> contextData, bool continueOnCapturedContext, CancellationToken cancellationToken) =>
        ExecuteAsync(action, new Context(contextData), continueOnCapturedContext, cancellationToken );
    ...
    /// <exception cref="InvalidOperationException">Please use asynchronous-defined policies when calling asynchronous ExecuteAsync (and similar) methods.</exception>
    [DebuggerStepThrough]
    public async Task ExecuteAsync(Func<Context, CancellationToken, Task> action, Context context, bool continueOnCapturedContext, CancellationToken cancellationToken)
    {
        ...
        try
        {
            await ImplementationAsync(action, context, continueOnCapturedContext, cancellationToken).ConfigureAwait(continueOnCapturedContext);
        }
        finally
        {
    ...
    /// <exception cref="ArgumentNullException">contextData</exception>
    [DebuggerStepThrough]
    public Task<TResult> ExecuteAsync<TResult>(Func<Context, CancellationToken, Task<TResult>> action, IDictionary<string, object> contextData, bool continueOnCapturedContext, CancellationToken cancellationToken) =>
        ExecuteAsync(action, new Context(contextData), continueOnCapturedContext, cancellationToken);
    ...
    /// <exception cref="InvalidOperationException">Please use asynchronous-defined policies when calling asynchronous ExecuteAsync (and similar) methods.</exception>
    [DebuggerStepThrough]
    public async Task<TResult> ExecuteAsync<TResult>(Func<Context, CancellationToken, Task<TResult>> action, Context context, bool continueOnCapturedContext, CancellationToken cancellationToken)
    {
        if (context == null) throw new ArgumentNullException(nameof(context));
        ...
        try
        {
            return await ImplementationAsync(action, context, continueOnCapturedContext, cancellationToken).ConfigureAwait(continueOnCapturedContext);
        }
        finally
        {
            PolicyBase.RestorePolicyContext(context, priorPolicyWrapKey, priorPolicyKey);
    ...
    public Task<PolicyResult> ExecuteAndCaptureAsync(Func<Task> action) =>
        ExecuteAndCaptureAsync((_, _) => action(), new Context(), DefaultContinueOnCapturedContext, DefaultCancellationToken);
    ...
    public Task<PolicyResult> ExecuteAndCaptureAsync(Func<Context, Task> action, IDictionary<string, object> contextData) =>
        ExecuteAndCaptureAsync((ctx, _) => action(ctx), new Context(contextData), DefaultContinueOnCapturedContext, DefaultCancellationToken);
    ...
    public Task<PolicyResult> ExecuteAndCaptureAsync(Func<Context, Task> action, Context context) =>
        ExecuteAndCaptureAsync((ctx, _) => action(ctx), context, DefaultContinueOnCapturedContext, DefaultCancellationToken);
    ...
    public Task<PolicyResult> ExecuteAndCaptureAsync(Func<CancellationToken, Task> action, CancellationToken cancellationToken) =>
        ExecuteAndCaptureAsync((_, ct) => action(ct), new Context(), DefaultContinueOnCapturedContext, cancellationToken);
    ...
    public Task<PolicyResult> ExecuteAndCaptureAsync(Func<Context, CancellationToken, Task> action, IDictionary<string, object> contextData, CancellationToken cancellationToken) =>
        ExecuteAndCaptureAsync(action, new Context(contextData), DefaultContinueOnCapturedContext, cancellationToken);
    ...
    public Task<PolicyResult> ExecuteAndCaptureAsync(Func<Context, CancellationToken, Task> action, Context context, CancellationToken cancellationToken) =>
        ExecuteAndCaptureAsync(action, context, DefaultContinueOnCapturedContext, cancellationToken);
    ...
    /// <exception cref="InvalidOperationException">Please use asynchronous-defined policies when calling asynchronous ExecuteAsync (and similar) methods.</exception>
    [DebuggerStepThrough]
    public Task<PolicyResult> ExecuteAndCaptureAsync(Func<CancellationToken, Task> action, bool continueOnCapturedContext, CancellationToken cancellationToken) =>
        ExecuteAndCaptureAsync((_, ct) => action(ct), new Context(), continueOnCapturedContext, cancellationToken);
    ...
    /// <returns>The captured result</returns>
    [DebuggerStepThrough]
    public Task<PolicyResult> ExecuteAndCaptureAsync(Func<Context, CancellationToken, Task> action, IDictionary<string, object> contextData, bool continueOnCapturedContext, CancellationToken cancellationToken) =>
        ExecuteAndCaptureAsync(action, new Context(contextData), continueOnCapturedContext, cancellationToken);
    ...
    /// <exception cref="InvalidOperationException">Please use asynchronous-defined policies when calling asynchronous ExecuteAsync (and similar) methods.</exception>
    [DebuggerStepThrough]
    public async Task<PolicyResult> ExecuteAndCaptureAsync(Func<Context, CancellationToken, Task> action, Context context, bool continueOnCapturedContext, CancellationToken cancellationToken)
    {
        if (context == null) throw new ArgumentNullException(nameof(context));

        try
        {
            await ExecuteAsync(action, context, continueOnCapturedContext, cancellationToken).ConfigureAwait(continueOnCapturedContext);
    ...
    /// <exception cref="InvalidOperationException">Please use asynchronous-defined policies when calling asynchronous ExecuteAsync (and similar) methods.</exception>
    [DebuggerStepThrough]
    public Task<PolicyResult<TResult>> ExecuteAndCaptureAsync<TResult>(Func<CancellationToken, Task<TResult>> action, bool continueOnCapturedContext, CancellationToken cancellationToken) =>
        ExecuteAndCaptureAsync((_, ct) => action(ct), new Context(), continueOnCapturedContext, cancellationToken);
    ...
    /// <exception cref="ArgumentNullException">contextData</exception>
    [DebuggerStepThrough]
    public Task<PolicyResult<TResult>> ExecuteAndCaptureAsync<TResult>(Func<Context, CancellationToken, Task<TResult>> action, IDictionary<string, object> contextData, bool continueOnCapturedContext, CancellationToken cancellationToken) =>
        ExecuteAndCaptureAsync(action, new Context(contextData), continueOnCapturedContext, cancellationToken);
    ...
    /// <exception cref="InvalidOperationException">Please use asynchronous-defined policies when calling asynchronous ExecuteAsync (and similar) methods.</exception>
    [DebuggerStepThrough]
    public async Task<PolicyResult<TResult>> ExecuteAndCaptureAsync<TResult>(Func<Context, CancellationToken, Task<TResult>> action, Context context, bool continueOnCapturedContext, CancellationToken cancellationToken)
    {
        if (context == null) throw new ArgumentNullException(nameof(context));
        ...
        try
        {
            return PolicyResult<TResult>.Successful(
                await ExecuteAsync(action, context, continueOnCapturedContext, cancellationToken).ConfigureAwait(continueOnCapturedContext), context);
        }
        catch (Exception exception)
        {
