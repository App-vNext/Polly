...
namespace Polly
{
    ...
    {
        private TResult DespatchExecutionSync<TExecutable>(TExecutable action, Context context, CancellationToken cancellationToken)
        ...
        private PolicyResult<TResult> DespatchExecuteAndCapture<TExecutable>(TExecutable action, Context context, CancellationToken cancellationToken)
            where TExecutable : ISyncExecutable<TResult>
        {
            if (context == null) throw new ArgumentNullException(nameof(context));
            ...
            try
            {
                TResult result = DespatchExecutionSync(action, context, cancellationToken);
        ...
        public TResult Execute<T1>(Func<Context, CancellationToken, T1, TResult> func, Context context, CancellationToken cancellationToken, T1 input1)
        {
            ...
            return DespatchExecutionSync(new SyncExecutableFunc<T1, TResult>(func, input1), context, cancellationToken);
        }
        ...
        public TResult Execute<T1, T2>(Func<Context, CancellationToken, T1, T2, TResult> func, Context context, CancellationToken cancellationToken, T1 input1, T2 input2)
        {
            ...
            return DespatchExecutionSync(new SyncExecutableFunc<T1, T2, TResult>(func, input1, input2), context, cancellationToken);
        }
