...
namespace Polly
{
    public partial class Policy
    {
        ...
        public static CachePolicy Cache(ISyncCacheProvider cacheProvider, TimeSpan ttl)
            => Cache(cacheProvider, new RelativeTtl(ttl), _ => { });
        ...
        public static CachePolicy Cache(ISyncCacheProvider cacheProvider, ITtlStrategy ttlStrategy)
            => Cache(cacheProvider, ttlStrategy, _ => { });
        ...
        /// <returns>The policy instance.</returns>
        /// <exception cref="ArgumentNullException">cacheProvider</exception>
        public static CachePolicy Cache(ISyncCacheProvider cacheProvider, TimeSpan ttl, Action<Context, string, Exception> onCacheError)
        ...
        public static CachePolicy Cache(ISyncCacheProvider cacheProvider, TimeSpan ttl, Func<Context, string> cacheKeyStrategy, Action<Context, string, Exception> onCacheError = null)
        {
            ...
            return Cache(cacheProvider, new RelativeTtl(ttl), options =>
            {
