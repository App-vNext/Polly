...
namespace Polly
{
    public partial class Policy
    {
        ...
        public static AsyncCachePolicy CacheAsync(IAsyncCacheProvider cacheProvider, TimeSpan ttl)
            => CacheAsync(cacheProvider, new RelativeTtl(ttl), _ => { });
        ...
        public static AsyncCachePolicy CacheAsync(IAsyncCacheProvider cacheProvider, ITtlStrategy ttlStrategy)
            => CacheAsync(cacheProvider, ttlStrategy, _ => { });
        ...
        /// <returns>The policy instance.</returns>
        /// <exception cref="ArgumentNullException">cacheProvider</exception>
        public static AsyncCachePolicy CacheAsync(IAsyncCacheProvider cacheProvider, TimeSpan ttl, Action<Context, string, Exception> onCacheError)
            => CacheAsync(cacheProvider, new RelativeTtl(ttl), options =>
            {
        ...
        public static AsyncCachePolicy CacheAsync(IAsyncCacheProvider cacheProvider, TimeSpan ttl, Func<Context, string> cacheKeyStrategy, Action<Context, string, Exception> onCacheError = null)
        {
            ...
            return CacheAsync(cacheProvider, new RelativeTtl(ttl), options =>
            {
