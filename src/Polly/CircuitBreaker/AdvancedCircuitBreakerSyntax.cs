...
namespace Polly
{
    ...
    public static class AdvancedCircuitBreakerSyntax
    {
        ...
        public static CircuitBreakerPolicy AdvancedCircuitBreaker(this PolicyBuilder policyBuilder, double failureThreshold, TimeSpan samplingDuration, int minimumThroughput, Func<int, TimeSpan> factoryForNextBreakDuration)
        {
        ...
        /// <exception cref="ArgumentNullException">onBreak</exception>
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy AdvancedCircuitBreaker(this PolicyBuilder policyBuilder, double failureThreshold, TimeSpan samplingDuration, int minimumThroughput, Func<int, TimeSpan> factoryForNextBreakDuration, Action<Exception, TimeSpan> onBreak, Action onReset)
        ...
        /// <exception cref="ArgumentNullException">onBreak</exception>
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy AdvancedCircuitBreaker(this PolicyBuilder policyBuilder, double failureThreshold, TimeSpan samplingDuration, int minimumThroughput, Func<int, TimeSpan> factoryForNextBreakDuration, Action<Exception, TimeSpan, Context> onBreak, Action<Context> onReset)
        {
        ...
        /// <exception cref="ArgumentNullException">onReset</exception>
        /// <exception cref="ArgumentNullException">onHalfOpen</exception>
        public static CircuitBreakerPolicy AdvancedCircuitBreaker(this PolicyBuilder policyBuilder, double failureThreshold, TimeSpan samplingDuration, int minimumThroughput, Func<int, TimeSpan> factoryForNextBreakDuration, Action<Exception, TimeSpan> onBreak, Action onReset, Action onHalfOpen)
            => policyBuilder.AdvancedCircuitBreaker(
                failureThreshold, samplingDuration, minimumThroughput,
                factoryForNextBreakDuration,
                (exception, timespan, context) => onBreak(exception, timespan),
        ...
        /// <exception cref="ArgumentNullException">onHalfOpen</exception>
        /// <remarks>(see "Release It!" by Michael T. Nygard fi)</remarks>
        public static CircuitBreakerPolicy AdvancedCircuitBreaker(this PolicyBuilder policyBuilder, double failureThreshold, TimeSpan samplingDuration, int minimumThroughput, Func<int, TimeSpan> factoryForNextBreakDuration, Action<Exception, TimeSpan, Context> onBreak, Action<Context> onReset, Action onHalfOpen)
            => policyBuilder.AdvancedCircuitBreaker(
                failureThreshold, samplingDuration, minimumThroughput,
                factoryForNextBreakDuration,
        ...
        /// <exception cref="ArgumentNullException">onHalfOpen</exception>
        /// <remarks>(see "Release It!" by Michael T. Nygard fi)</remarks>
        public static CircuitBreakerPolicy AdvancedCircuitBreaker(this PolicyBuilder policyBuilder, double failureThreshold, TimeSpan samplingDuration, int minimumThroughput, Func<int, TimeSpan> factoryForNextBreakDuration, Action<Exception, CircuitState, TimeSpan, Context> onBreak, Action<Context> onReset, Action onHalfOpen)
        {
