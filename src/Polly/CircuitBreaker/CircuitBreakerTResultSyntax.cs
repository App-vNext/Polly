...
namespace Polly
{
    ...
    public static class CircuitBreakerTResultSyntax
    {
        ...
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, TimeSpan durationOfBreak)
        {
            ValidateStaticDurationIsNonNegative(durationOfBreak);
            return policyBuilder.CircuitBreaker(failureThreshold, (_) => durationOfBreak);
        }
        ...
        /// </para>
        /// <para>If the first action after the break duration period results in a failure, the circuit will break
        /// again for a newly calculated duration; if no failure is encountered, the circuit will reset.
        /// </para>
        /// </summary>
        /// <param name="policyBuilder">The policy builder.</param>
        /// <param name="failureThreshold">The number of failures that are allowed before opening the circuit.</param>
        ...
        /// <exception cref="ArgumentNullException">onBreak</exception>
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, Func<int, TimeSpan> factoryForNextBreakDuration)
        {
        ...
        /// <exception cref="ArgumentNullException">onBreak</exception>
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, TimeSpan durationOfBreak, Action<DelegateResult<TResult>, TimeSpan> onBreak, Action onReset)
        {
            ValidateStaticDurationIsNonNegative(durationOfBreak);
            return policyBuilder.CircuitBreaker(failureThreshold, (_) => durationOfBreak, onBreak, onReset);
        }
        ...
        /// <exception cref="ArgumentNullException">onBreak</exception>
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, Func<int, TimeSpan> factoryForNextBreakDuration, Action<DelegateResult<TResult>, TimeSpan> onBreak, Action onReset)
        ...
        /// <exception cref="ArgumentNullException">onBreak</exception>
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, TimeSpan durationOfBreak, Action<DelegateResult<TResult>, TimeSpan, Context> onBreak, Action<Context> onReset)
        {
            ValidateStaticDurationIsNonNegative(durationOfBreak);
            return policyBuilder.CircuitBreaker(failureThreshold, (_) => durationOfBreak, onBreak, onReset);
        }
        ...
        /// <exception cref="ArgumentNullException">onBreak</exception>
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, Func<int, TimeSpan> factoryForNextBreakDuration, Action<DelegateResult<TResult>, TimeSpan, Context> onBreak, Action<Context> onReset)
        {
        ...
        /// <exception cref="ArgumentNullException">onBreak</exception>
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, TimeSpan durationOfBreak, Action<DelegateResult<TResult>, TimeSpan> onBreak, Action onReset, Action onHalfOpen)
        {
            ValidateStaticDurationIsNonNegative(durationOfBreak);
            return policyBuilder.CircuitBreaker(failureThreshold, (_) => durationOfBreak, onBreak, onReset, onHalfOpen);
        }
        ...
        /// <exception cref="ArgumentNullException">onBreak</exception>
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, Func<int, TimeSpan> factoryForNextBreakDuration, Action<DelegateResult<TResult>, TimeSpan> onBreak, Action onReset, Action onHalfOpen)
            => policyBuilder.CircuitBreaker(
                failureThreshold,
                factoryForNextBreakDuration,
                (outcome, timespan, context) => onBreak(outcome, timespan),
        ...
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, TimeSpan durationOfBreak, Action<DelegateResult<TResult>, TimeSpan, Context> onBreak, Action<Context> onReset, Action onHalfOpen)
        {
            ValidateStaticDurationIsNonNegative(durationOfBreak);
            return policyBuilder.CircuitBreaker(failureThreshold, (_) => durationOfBreak, onBreak, onReset, onHalfOpen);
        }
        ...
        /// <exception cref="ArgumentNullException">onReset</exception>
        /// <exception cref="ArgumentNullException">onHalfOpen</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, Func<int, TimeSpan> factoryForNextBreakDuration, Action<DelegateResult<TResult>, TimeSpan, Context> onBreak, Action<Context> onReset, Action onHalfOpen)
            => policyBuilder.CircuitBreaker(
                failureThreshold,
                factoryForNextBreakDuration,
        ...
        /// <exception cref="ArgumentNullException">onReset</exception>
        /// <exception cref="ArgumentNullException">onHalfOpen</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, TimeSpan durationOfBreak, Action<DelegateResult<TResult>, CircuitState, TimeSpan, Context> onBreak, Action<Context> onReset, Action onHalfOpen)
        {
            ValidateStaticDurationIsNonNegative(durationOfBreak);
            return policyBuilder.CircuitBreaker(failureThreshold, (_) => durationOfBreak, onBreak, onReset, onHalfOpen);
        }
        ...
        /// <exception cref="ArgumentNullException">onReset</exception>
        /// <exception cref="ArgumentNullException">onHalfOpen</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int failureThreshold, Func<int, TimeSpan> factoryForNextBreakDuration, Action<DelegateResult<TResult>, CircuitState, TimeSpan, Context> onBreak, Action<Context> onReset, Action onHalfOpen)
        {
