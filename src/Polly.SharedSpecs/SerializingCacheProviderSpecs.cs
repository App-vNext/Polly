...
namespace Polly.Specs
{
    public class SerializingCacheProviderSpecs
    {
        ...
        [Fact]
        public void Single_generic_SerializingCacheProvider_should_get_on_deserialize()
        {
        ...
        [Fact]
        public void Single_generic_SerializingCacheProvider_from_extension_syntax_should_get_on_deserialize()
        {
            bool deserializeInvoked = false;
            var mockSerializer = new ManualMockSerializer(o => o, o => { deserializeInvoked = true; return ((Tuple<object>)o).Item1; });
            var stubCacheProvider = new StubCacheProvider();
        ...
        [Fact]
        public void Double_generic_SerializingCacheProvider_should_get_on_deserialize()
        {
            bool deserializeInvoked = false;
            var mockSerializer = new ManualMockSerializer(o => o, o => { deserializeInvoked = true; return ((Tuple<object>)o).Item1; });
            var stubCacheProvider = new StubCacheProvider();
        ...
        [Fact]
        public void Double_generic_SerializingCacheProvider_from_extension_syntax_should_get_on_deserialize()
        {
            bool deserializeInvoked = false;
            var mockSerializer = new ManualMockSerializer(o => o, o => { deserializeInvoked = true; return ((Tuple<object>)o).Item1; });
            var stubCacheProvider = new StubCacheProvider();
