...
namespace Polly.Specs.Retry
{
    public class RetryTResultSpecsAsync
    {
        ...
        public async Task Should_not_return_handled_result_when_handled_result_raised_same_number_of_times_as_retry_count()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(ResultPrimitive.Fault, ResultPrimitive.Fault, ResultPrimitive.Fault, ResultPrimitive.Good).ConfigureAwait(false);
        ...
        public async Task Should_not_return_handled_result_when_one_of_the_handled_results_raised_same_number_of_times_as_retry_count()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(ResultPrimitive.Fault, ResultPrimitive.FaultAgain, ResultPrimitive.Fault, ResultPrimitive.Good).ConfigureAwait(false);
            result.Should().Be(ResultPrimitive.Good);
        }
        ...
        public async Task Should_not_return_handled_result_when_handled_result_raised_less_number_of_times_than_retry_count()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(ResultPrimitive.Fault, ResultPrimitive.Good).ConfigureAwait(false);
            result.Should().Be(ResultPrimitive.Good);
        }
        ...
        public async Task Should_not_return_handled_result_when_all_of_the_handled_results_raised_less_number_of_times_than_retry_count()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(ResultPrimitive.Fault, ResultPrimitive.FaultAgain, ResultPrimitive.Good).ConfigureAwait(false);
            result.Should().Be(ResultPrimitive.Good);
        }
        ...
        public async Task Should_return_handled_result_when_handled_result_raised_more_times_then_retry_count()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(ResultPrimitive.Fault, ResultPrimitive.Fault, ResultPrimitive.Fault, ResultPrimitive.Fault, ResultPrimitive.Good).ConfigureAwait(false);
        ...
        public async Task Should_return_handled_result_when_one_of_the_handled_results_is_raised_more_times_then_retry_count()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(ResultPrimitive.FaultAgain, ResultPrimitive.FaultAgain, ResultPrimitive.FaultAgain, ResultPrimitive.FaultAgain, ResultPrimitive.Good).ConfigureAwait(false);
        ...
        public async Task Should_return_result_when_result_is_not_the_specified_handled_result()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(ResultPrimitive.FaultAgain, ResultPrimitive.Good).ConfigureAwait(false);
            result.Should().Be(ResultPrimitive.FaultAgain);
        }
        ...
        public async Task Should_return_result_when_result_is_not_one_of_the_specified_handled_results()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(ResultPrimitive.FaultYetAgain, ResultPrimitive.Good).ConfigureAwait(false);
        ...
        public async Task Should_return_result_when_specified_result_predicate_is_not_satisfied()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(new ResultClass(ResultPrimitive.FaultAgain), new ResultClass(ResultPrimitive.Good)).ConfigureAwait(false);
        ...
        public async Task Should_return_result_when_none_of_the_specified_result_predicates_are_satisfied()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(new ResultClass(ResultPrimitive.FaultYetAgain), new ResultClass(ResultPrimitive.Good)).ConfigureAwait(false);
        ...
        public async Task Should_not_return_handled_result_when_specified_result_predicate_is_satisfied()
        {
            ...
            var result = await policy.RaiseResultSequenceAsync(new ResultClass(ResultPrimitive.Fault), new ResultClass(ResultPrimitive.Good)).ConfigureAwait(false);
