...
namespace Polly.Specs.Caching
{
    ...
    public class CacheTResultAsyncSpecs : IDisposable
    {
        ...
        public async Task Should_allow_custom_FuncCacheKeyStrategy()
        {
            ...
            Func<Context, Task<ResultClass>> func = async ctx => { funcExecuted = true; await Task.CompletedTask.ConfigureAwait(false); return new ResultClass(ResultPrimitive.Fault, "should never return this one"); };
