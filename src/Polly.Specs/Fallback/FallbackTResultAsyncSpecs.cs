...
namespace Polly.Specs.Fallback
{
    public class FallbackTResultAsyncSpecs
    {
        ...
        {
            Func<CancellationToken, Task<ResultPrimitive>> fallbackAction = null;
            Func<DelegateResult<ResultPrimitive>, Task> onFallbackAsync = ct => Task.CompletedTask;
        ...
        public void Should_throw_when_fallback_action_is_null_with_onFallback_with_context()
        {
            ...
            Func<DelegateResult<ResultPrimitive>, Context, Task> onFallbackAsync = (_, __) => Task.CompletedTask;
        ...
        public async Task Should_call_onFallback_passing_result_triggering_fallback()
        {
            ...
            Func<DelegateResult<ResultClass>, Task> onFallbackAsync = r => { resultPassedToOnFallback = r.Result; return Task.CompletedTask; };

            var fallbackPolicy = Policy
                .HandleResult<ResultClass>(r => r.ResultCode == ResultPrimitive.Fault)
                .FallbackAsync(fallbackAction, onFallbackAsync);

            var resultFromDelegate = new ResultClass(ResultPrimitive.Fault);
        ...
        public async Task Should_not_call_onFallback_when_executed_delegate_does_not_raise_fault()
        {
            ...
            Func<DelegateResult<ResultPrimitive>, Task> onFallbackAsync = ct => { onFallbackExecuted = true; return Task.CompletedTask; };
        ...
        public void Should_call_onFallback_with_the_passed_context()
        {
            ...
            Func<DelegateResult<ResultPrimitive>, Context, Task> onFallbackAsync = (dr, ctx) => { contextData = ctx; return Task.CompletedTask; };
        ...
        public async Task Should_call_onFallback_with_the_passed_context_when_execute_and_capture()
        {
            ...
            Func<DelegateResult<ResultPrimitive>, Context, Task> onFallbackAsync = (ex, ctx) => { contextData = ctx; return Task.CompletedTask; };
        ...
        public void Should_call_onFallback_with_independent_context_for_independent_calls()
        {
            ...
            Func<DelegateResult<ResultPrimitive>, Context, Task> onFallbackAsync = (dr, ctx) => { contextData[dr.Result] = ctx["key"]; return Task.CompletedTask; };
        ...
        public async Task Context_should_be_empty_if_execute_not_called_with_any_context_data()
        {
            ...
            Func<Context, CancellationToken, Task<ResultPrimitive>> fallbackAction = (_, __) => Task.FromResult(ResultPrimitive.Substitute);
            Func<DelegateResult<ResultPrimitive>, Context, Task> onFallbackAsync = (ex, ctx) => { onFallbackExecuted = true; capturedContext = ctx; return Task.CompletedTask; };
        ...
        public void Should_call_fallbackAction_with_the_passed_context()
        {
            ...
            Func<DelegateResult<ResultPrimitive>, Context, Task> onFallbackAsync = (dr, ctx) => Task.CompletedTask;
        ...
        public async Task Context_should_be_empty_at_fallbackAction_if_execute_not_called_with_any_context_data()
        {
            ...
            Func<Context, CancellationToken, Task<ResultPrimitive>> fallbackActionAsync = (ctx, ct) =>
            {
                fallbackExecuted = true; capturedContext = ctx; return Task.FromResult(ResultPrimitive.Substitute);
            };
            Func<DelegateResult<ResultPrimitive>, Context, Task> onFallbackAsync = (ex, ctx) => Task.CompletedTask;
        ...
        public async Task Should_call_fallbackAction_with_the_fault()
        {
            ...
            Func<DelegateResult<ResultPrimitive>, Context, Task> onFallback = (ex, ctx) => { return Task.CompletedTask; };
