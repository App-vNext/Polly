...
namespace Polly.Specs.Helpers
{
    public static class PolicyExtensionsAsync
    {
        ...
        public static Task RaiseExceptionAsync<TException>(this Policy policy, Action<TException, int> configureException = null) where TException : Exception, new() => policy.RaiseExceptionAsync(1, configureException);
