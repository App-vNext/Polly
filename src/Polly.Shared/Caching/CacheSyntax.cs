...
namespace Polly
{
    public partial class Policy
    {
        ...
        {
            return Cache(cacheProvider, new RelativeTtl(ttl), DefaultCacheKeyStrategy.Instance, onCacheError);
        }
        ...
        {
            return Cache(cacheProvider, ttlStrategy, DefaultCacheKeyStrategy.Instance, onCacheError);
        }
