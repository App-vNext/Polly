...
namespace Polly
{
    public partial class Policy
    {
        ...
        {
            return CacheAsync(cacheProvider, new RelativeTtl(ttl), DefaultCacheKeyStrategy.Instance, onCacheError);
        }
        ...
        {
            return CacheAsync(cacheProvider, ttlStrategy, DefaultCacheKeyStrategy.Instance, onCacheError);
        }
