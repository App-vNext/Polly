...
namespace Polly
{
    ...
    public static class TimesliceCircuitBreakerSyntax
    {
        ...
        /// <para>The circuit will break if, within any timeslice of duration <paramref name="timesliceDuration"/>, the proportion of failures exceeds <paramref name="failureThreshold"/>, provided also that the number of calls through the circuit in the timeslice exceeds <paramref name="minimumThroughput" />. The circuit will stay
        ...
        /// <param name="failureThreshold">The failure threshold at which the circuit will break (a number between 0 and 1; eg 0.5 represents a 50% failure threshold.</param>
        /// <param name="timesliceDuration">the duration of the timeslice over which call failure ratios are assessed.</param>
        /// <param name="minimumThroughput">The minimum throughput of calls through the circuit which must be exceeded, for the circuit-breaker to come into operation.</param>
