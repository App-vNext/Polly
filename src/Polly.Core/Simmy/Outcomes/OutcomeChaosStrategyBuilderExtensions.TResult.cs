...
public static partial class OutcomeChaosStrategyBuilderExtensions
{
    ...
    public static ResilienceStrategyBuilder<TResult> AddFault<TResult>(this ResilienceStrategyBuilder<TResult> builder, bool enabled, double injectionRate, Exception fault)
    {
        Guard.NotNull(builder);

        return builder.AddFaultCore<ResilienceStrategyBuilder<TResult>, TResult>(new OutcomeStrategyOptions<Exception>
        {
            Enabled = enabled,
    ...
    /// <returns>The builder instance with the retry strategy added.</returns>
    public static ResilienceStrategyBuilder<TResult> AddFault<TResult>(
        this ResilienceStrategyBuilder<TResult> builder, bool enabled, double injectionRate, Func<ValueTask<Outcome<Exception>>> faultGenerator)
    {
        Guard.NotNull(builder);
    ...
    /// <returns>The builder instance with the retry strategy added.</returns>
    public static ResilienceStrategyBuilder<TResult> AddFault<TResult>(this ResilienceStrategyBuilder<TResult> builder, OutcomeStrategyOptions<Exception> options)
    {
        Guard.NotNull(builder);
        Guard.NotNull(options);

        return builder.AddFaultCore<ResilienceStrategyBuilder<TResult>, TResult>(options);
    }
